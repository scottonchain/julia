...
blur = img.filter(ImageFilter.GaussianBlur(radius=2))   # changed radius for blur effect
glow = Image.blend(img, blur, alpha=0.1)   # changed alpha value for glow effect
