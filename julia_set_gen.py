...
image_size = 800
x_range = (-1.5 + 0.2j, -0.7 + 0.2j)  # Change the center of the julia set
y_range = (-1.8, 1.8)
c = complex(-0.75, 0.25)  # Tweak this for different shapes
max_iterations = 300
...
glow = Image.blend(img, blur, alpha=0.4)  # Change the alpha value for glow
